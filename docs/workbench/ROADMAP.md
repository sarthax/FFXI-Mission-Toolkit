...
- [x] Add machine-readable `GUI_ROUTE_MAP.json` and CI regression coverage for the current FastAPI route surface (142 routes after Live Target Validation UI exposure).
