...
- [x] Add machine-readable `GUI_ROUTE_MAP.json` and CI regression coverage for the current FastAPI route surface (140 routes after Validation workspace exposure).
...
- [x] Expose Validation dashboard and ValidationRun/ValidationResult browsing as read-only views over the canonical Workbench graph; Live Target remains a planned dedicated UI.
