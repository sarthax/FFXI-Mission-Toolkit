...
eventview.defaults.color.event_header = 18 -- CS Event (0x032), CS Event + Params (0x034)
...
eventview.initialize = function()
  ...
  eventview.h = { -- Headers for log string. ex: NPC:
    eventview  = eventview.color.log.SYSTEM .. '[ID View] ',
  ...
  eventview.template.EVENT_PARAMS = ' ${dir|%s} ${type|%s}'.. 
                                 ...
                                 '${p1|%s} ${p2|%s} ${p3|%s} ${p4|%s}\n    ${p5|%s} ${p6|%s} ${p7|%s} ${p8|%s}'
  eventview.template.OPTION       = ' ${dir|%s} ${type|%s}'..eventview.color.box.SYSTEM ..'[ID View]\n Event: ${event|%s} '..
                                 eventview.color.box.SYSTEM ..'Actor: ${actor|%s}\n'..eventview.color.box.SYSTEM ..' Option: ${option|%s}\n '
  eventview.template.UPDATE       = ' ${dir|%s} ${type|%s}'.. eventview.color.box.SYSTEM ..'[ID View]\n'..
                                 ' P: '.. eventview.color.box.PARAMS ..'${p1|%s} ${p2|%s} ${p3|%s} ${p4|%s}\n    ${p5|%s} ${p6|%s} ${p7|%s} ${p8|%s}\n '
  eventview.template.NPC_CHAT     = ' ${dir|%s} ${type|%s}'..eventview.color.box.SYSTEM ..'[ID View]\n'..eventview.color.box.SYSTEM ..' Actor: ${actor|%s}\n'..
