...
def _common(equipment_file: str = "item_equipment.sql") -> dict[str, TableShape]:
    ...
    synth_fields=(
        ...
        FieldMapping("key_item_id",("KeyItem","keyitem")),
        FieldMapping("woodworking",("Wood","wood")),
        FieldMapping("smithing",("Smith","smith")),
        FieldMapping("goldsmithing",("Gold","gold")),
        FieldMapping("clothcraft",("Cloth","cloth")),
        FieldMapping("leathercraft",("Leather","leather")),
        FieldMapping("bonecraft",("Bone","bone")),
        FieldMapping("alchemy",("Alchemy","alchemy")),
        FieldMapping("cooking",("Cook","cook")),
        FieldMapping("crystal_item_id",("Crystal","crystal")),
        FieldMapping("hq_crystal_item_id",("HQCrystal","hqcrystal")),
        FieldMapping("ingredient_1",("Ingredient1","ingredient1")),
        FieldMapping("ingredient_2",("Ingredient2","ingredient2")),
        FieldMapping("ingredient_3",("Ingredient3","ingredient3")),
        FieldMapping("ingredient_4",("Ingredient4","ingredient4")),
        FieldMapping("ingredient_5",("Ingredient5","ingredient5")),
        FieldMapping("ingredient_6",("Ingredient6","ingredient6")),
        FieldMapping("ingredient_7",("Ingredient7","ingredient7")),
        FieldMapping("ingredient_8",("Ingredient8","ingredient8")),
        FieldMapping("result_item_id",("Result","result"),True),
        FieldMapping("result_hq1_item_id",("ResultHQ1","resulthq1")),
        FieldMapping("result_hq2_item_id",("ResultHQ2","resulthq2")),
        FieldMapping("result_hq3_item_id",("ResultHQ3","resulthq3")),
        FieldMapping("result_qty",("ResultQty","resultqty")),
        FieldMapping("result_hq1_qty",("ResultHQ1Qty","resulthq1qty")),
        FieldMapping("result_hq2_qty",("ResultHQ2Qty","resulthq2qty")),
        FieldMapping("result_hq3_qty",("ResultHQ3Qty","resulthq3qty")),
        FieldMapping("result_name",("ResultName","resultname")),
        FieldMapping("content_tag",("content_tag",)),
    )
    synergy_fields=(
        FieldMapping("recipe_id",("id","ID"),True),
        FieldMapping("primary_skill",("primary_skill",)),
        FieldMapping("primary_rank",("primary_rank",)),
        FieldMapping("secondary_skill",("secondary_skill",)),
        FieldMapping("secondary_rank",("secondary_rank",)),
        FieldMapping("tertiary_skill",("tertiary_skill",)),
        FieldMapping("tertiary_rank",("tertiary_rank",)),
        FieldMapping("cost_fire_fewell",("cost_fire_fewell",)),
        FieldMapping("cost_ice_fewell",("cost_ice_fewell",)),
        FieldMapping("cost_wind_fewell",("cost_wind_fewell",)),
        FieldMapping("cost_earth_fewell",("cost_earth_fewell",)),
        FieldMapping("cost_lightning_fewell",("cost_lightning_fewell",)),
        FieldMapping("cost_water_fewell",("cost_water_fewell",)),
        FieldMapping("cost_light_fewell",("cost_light_fewell",)),
        FieldMapping("cost_dark_fewell",("cost_dark_fewell",)),
        FieldMapping("ingredient_1",("ingredient1",)),
        FieldMapping("ingredient_2",("ingredient2",)),
        FieldMapping("ingredient_3",("ingredient3",)),
        FieldMapping("ingredient_4",("ingredient4",)),
        FieldMapping("ingredient_5",("ingredient5",)),
        FieldMapping("ingredient_6",("ingredient6",)),
        FieldMapping("ingredient_7",("ingredient7",)),
        FieldMapping("ingredient_8",("ingredient8",)),
        FieldMapping("result_item_id",("result",),True),
        FieldMapping("result_hq1_item_id",("resultHQ1","resulthq1")),
        FieldMapping("result_hq2_item_id",("resultHQ2","resulthq2")),
        FieldMapping("result_hq3_item_id",("resultHQ3","resulthq3")),
        FieldMapping("result_qty",("resultQty","resultqty")),
    ...
    return {
        ...
        "synth_recipes": TableShape(
            "synth_recipes","synth_recipes.sql","synth_recipes",
            parse_columns=("ID","Desynth","KeyItem","Wood","Smith","Gold","Cloth","Leather","Bone","Alchemy","Cook",
                "Crystal","HQCrystal","Ingredient1","Ingredient2","Ingredient3","Ingredient4","Ingredient5","Ingredient6",
                "Ingredient7","Ingredient8","Result","ResultHQ1","ResultHQ2","ResultHQ3","ResultQty","ResultHQ1Qty",
                "ResultHQ2Qty","ResultHQ3Qty","ResultName","content_tag"),
            field_mappings=synth_fields, identity_fields=("recipe_id",),
            notes=("Logical synthesis recipe with explicit prerequisites; ingredient availability requires recursive acquisition closure.",),
        ),
        "synergy_recipes": TableShape(
            "synergy_recipes","synergy_recipes.sql","synergy_recipes",
            parse_columns=("id","primary_skill","primary_rank","secondary_skill","secondary_rank","tertiary_skill","tertiary_rank",
                "cost_fire_fewell","cost_ice_fewell","cost_wind_fewell","cost_earth_fewell","cost_lightning_fewell",
                "cost_water_fewell","cost_light_fewell","cost_dark_fewell","ingredient1","ingredient2","ingredient3",
                "ingredient4","ingredient5","ingredient6","ingredient7","ingredient8","result","resultHQ1","resultHQ2",
                "resultHQ3","resultQty","resultHQ1Qty","resultHQ2Qty","resultHQ3Qty","resultName"),
            field_mappings=synergy_fields, identity_fields=("recipe_id",),
            notes=("Synergy is a distinct crafting system/capability and must not be treated as ordinary synthesis.",),
        ),
    }
